...
DEFAULTS = {
    ...
    "checkout_intro_text": "Vyplňte fakturační údaje pro objednávku licence. Po zpracování vám zašleme platební údaje. Po zaplacení aktivujeme účet.",
    ...
    "checkout_submit_button": "Odeslat objednávku",
    "checkout_back_link": "Zpět na ceník",
    "checkout_placeholder_jmeno": "Ing. autorizovaný projektant",
    "checkout_placeholder_email": "vas-email@domena.cz",
    "checkout_placeholder_ulice": "Portál stavebníka",
    "checkout_placeholder_mesto": "Ostrava",
    "checkout_placeholder_psc": "702 00",
    "checkout_placeholder_ico": "87654321",
    "checkout_placeholder_dic": "CZ87654321",
...
CHECKOUT_PRICING_TEXT_KEYS = [
    ...
    "checkout_back_link",
    "checkout_placeholder_jmeno",
    "checkout_placeholder_email",
    "checkout_placeholder_ulice",
    "checkout_placeholder_mesto",
    "checkout_placeholder_psc",
    "checkout_placeholder_ico",
    "checkout_placeholder_dic",
