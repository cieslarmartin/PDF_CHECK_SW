# tsa_registry.py
# Registr TSA autorit platných pro ISSŘ (ČR). Whitelist pro vyhodnocení tsa_qualified.
...
def is_tsa_issuer_qualified(tsa_issuer, registry):
    ...
    registry: list of dict s klíči display_name, keywords (list), is_qualified (bool).
    """
